export const LoadFeedData = `copy into INIT_LOAD_V3 from (select parse_json(HEX_DECODE_STRING($1:Body)) from @{dbName}.{schemaName}.{stageName}/{partition}`
...
export const deleteDedupTemptable = `DROP TABLE dedup_temp;`
